...
class CreateJumlahPendudukJenisKelaminTable extends Migration {

	public function up()
	{
		Schema::create('jumlah_penduduk_jenis_kelamins', function(Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('jumlah_penduduk_jenis_kelamins');
	}
}