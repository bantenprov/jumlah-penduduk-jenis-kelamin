...
miniToastr.init();
export default {
    name: "jumlah_penduduk_jenis_kelamin_add",
    components: {
        Datepicker
    },
    data() {
        return {
            jumlah_penduduk_jenis_kelamins: [],
            provinces: [],
            regencies: {},
            formstate: {},
            model: {
    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/jumlah-penduduk-jenis-kelamin/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/jumlah-penduduk-jenis-kelamin/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/jumlah-penduduk-jenis-kelamin/create'
                  }
                },
                window.location.href = '#/admin/jumlah-penduduk-jenis-kelamin/create')
        ...
        back() {
            window.location = '#/admin/jumlah-penduduk-jenis-kelamin';
        }
    },
    mounted: function() {
        axios.get("/jumlah-penduduk-jenis-kelamin/create").then(response => {
